...
// @include     /^(https?://)?boards\.4chan\.org/.*/(res|thread)/.*$/
// @include     /^(https?://)?(www\.)?brantsteele\.net/hungergames/(edit|personal)\.php$/
// @include     https://pyral.io/hg/*
// @grant       GM_setValue
// @grant       GM_getValue
// ==/UserScript==
...
if(window.location.hostname == "boards.4chan.org" || window.location.hostname == "pyral.io") {
    ...
    hgKeybinds_div.appendChild(
        hgCreateElement_Span(
            ...
            "&nbsp;Draw",
            hgStringifyBinding(JSON.stringify(GM_getValue("drawBinding", "F1")))
        )
    );
    */
    ...
    */
    ...
    //hgCtrls_div.appendChild(hgKeybinds_button); // TODO: KEYBINDSTUFF
    hgCtrls_div.appendChild(hgSettings_div);
    //hgCtrls_div.appendChild(hgKeybinds_div); // TODO: KEYBINDSTUFF
